...
class TopicSerializer(serializers.HyperlinkedModelSerializer):
    ...
    all_comments = serializers.HyperlinkedIdentityField(
        view_name="api:comment-detail", many=True
    )
    ...
    content_object = GenericRelatedField(
        {
            Topic: serializers.HyperlinkedRelatedField(
                queryset=Topic.objects.all(), view_name="topic-detail"
            ),
